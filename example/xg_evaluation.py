...
from performance.xg_evaluate import *
...
python xg_evaluate.py --happy path/to/NA12878.vcf.happy.vcf --target path/to/NA12878.vcf --mode SNP --num_trees 150 --kind RF
            ''')
    ...
    optional.add_argument("--kind", choices=["XG", "XGboost"], type=str, default="RF",
            help="..")
