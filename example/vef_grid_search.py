...
python vef_grid_search.py --happy path/to/NA12878.vcf.happy.vcf --target path/to/NA12878.vcf --mode SNP --fold 5 --jobs 2 --kind RF
    ...
    optional.add_argument("--kind", choices=["RF", "RandomForest", "AB", "AdaBoost", "GB", "GradientBoost","SVM","SupportVecotr", "XG"], type=str, default="RF",
            help="kind of ensemble methods, available values: RandomForest (RF), AdaBoost (AB), GradientBoost(GB), SupportVecotr(SVM), XG; default = RF")
