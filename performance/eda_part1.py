    ...
    def _EDA(self,mode):
        ...
        for ch in self.contigs:
            if ch not in label_list:
                ...
                save_path = r'../plt/correlation_plot.png'
                ...
                save_path = r'../plt/AC_count_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/DP_scatter_plot.png'
                plt.savefig(save_path)

                # FS
                plt.clf()
                plt.scatter(df['variants/FS'], df['Label'])
                save_path = r'../plt/FS_scatter_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/MLEAC_count_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/BaseQRankSum_scatter_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/MQ_scatter_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/QD_scatter_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/QUAL_scatter_plot.png'
                plt.savefig(save_path)
                ...
                save_path = r'../plt/SOR_scatter_plot.png'
                plt.savefig(save_path)
